...
const COUNTRY_MAP_DATA = {
  uae: {
    ...
    cities: [
      { pos: [24.4478, 54.37], name: "Abu Dhabi", type: "capital" },
...
const MAP_CONFIGS = {
  uae: {
    ...
    regions: [
      { name: "UAE", labelLat: 24.0, labelLng: 54.0, path: gccBorders.country?.uae,
        // NaturalEarth 50m simplified (~36 pts)
        pts: [[25.65,56.30],[24.97,56.35],[24.80,56.15],[24.86,55.97],[24.95,56.00],[24.91,55.82],[24.64,55.80],[24.38,55.80],[24.22,55.93],[24.04,55.89],[23.94,55.47],[23.72,55.51],[23.19,55.27],[22.70,55.19],[22.63,55.00],[22.70,54.47],[22.80,53.61],[22.90,52.86],[22.93,52.56],[23.18,52.34],[23.45,52.12],[23.71,51.90],[23.97,51.68],[24.26,51.57],[24.25,51.66],[24.01,51.84],[24.11,52.51],[24.07,53.80],[24.28,54.40],[24.56,54.58],[25.04,55.10],[25.50,55.52],[26.06,56.08],[25.85,56.15],[25.63,56.25],[25.65,56.30]] },
    ],
    ...
    impacts: [
      ...
      { id: 6, name: "Zayed Intl Airport", type: "debris", date: "28 Feb", casualties: "1 killed, 7 injured", lat: 24.4045, lng: 54.6510, region: "Abu Dhabi" },
      { id: 7, name: "Camp de la Paix (French Naval Base)", type: "drone_hit", date: "1-2 Mar", casualties: "None", lat: 24.4253, lng: 54.3500, region: "Abu Dhabi" },
      { id: 8, name: "Etihad Towers", type: "debris", date: "28 Feb-3 Mar", casualties: "None", lat: 24.4175, lng: 54.3605, region: "Abu Dhabi" },
      ...
      { id: 11, name: "Al Dhafra Air Base", type: "drone_hit", date: "7 Mar", casualties: "None", lat: 24.226, lng: 54.5477, region: "Abu Dhabi" },
      ...
      { id: 14, name: "Corniche / Bateen area", type: "debris", date: "28 Feb", casualties: "None", lat: 24.44280, lng: 54.3300, region: "Abu Dhabi" },
      ...
      { id: 16, name: "Al Bahia (vehicle)", type: "drone_hit", date: "16 Mar", casualties: "1 killed", lat: 24.497800, lng: 54.4000, region: "Abu Dhabi" },
    ],
    strategicSites: [
  ...
  israel: {
    ...
    regions: [
      { name: "ISRAEL", labelLat: 31.5, labelLng: 34.9, path: gccBorders.country?.israel,
        // NaturalEarth 50m simplified (~36 pts)
        pts: [
          [33.42,35.84],[33.29,35.79],[33.20,35.83],[33.11,35.82],
          [32.94,35.89],[32.73,35.79],[32.67,35.59],[32.40,35.55],
          [32.49,35.39],[32.53,35.19],[32.28,35.00],[31.99,34.98],
          [31.84,34.95],[31.84,35.05],[31.75,35.20],[31.60,34.95],
          [31.37,34.88],[31.42,35.28],[31.33,35.42],[31.21,35.41],
          [30.86,35.32],[30.52,35.17],[30.20,35.13],[29.90,35.05],
          [29.48,34.90],[29.98,34.74],[30.51,34.52],[31.00,34.33],
          [31.36,34.35],[31.58,34.48],[32.20,34.80],[32.97,35.08],
          [33.08,35.31],[33.25,35.53],[33.28,35.63],[33.42,35.84],
        ]
      },
    ],
    impacts: [
  ...
  oman: {
    ...
    strategicSites: [
      ...
      { id: "om-d2", name: "Sohar Desal", type: "Desalination", siteType: "desal", lat: 24.447824, lng: 56.6334 },
...
function Dashboard({ initialTab, initialCountry, onBack }) {
  ...
  const allTabs = [
    ...
    { id: "flights",    label: t("tab.flights"), isLink: true },
    { id: "alarm",      label: "Alarm Frequency" },
  ];
  const tabs = isAllGCC ? [{ id: "intel", label: t("tab.intel") }, { id: "comparison", label: t("tab.comparison") }, { id: "alarm", label: "Alarm Frequency" }] : allTabs.filter(t => {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"} style={{ background: BG, minHeight: "100vh", color: TEXT, fontFamily: DM_SANS, padding: "0 0 40px", overflowX: "hidden", position: "relative" }}>
      ...
      <div style={{ display: "flex", gap: 0, padding: "0 28px 20px", flexWrap: "wrap", borderBottom: "1px solid #FFFFFF0A" }}>
        {tabs.map(t => (
          <button key={t.id} onClick={() => { if (t.isLink) { window.location.hash = "/flights"; return; } setActiveTab(t.id); window.location.hash = "/threat/" + selectedCountry + (t.id !== "overview" && t.id !== "intel" ? "/" + t.id : ""); }} style={{
      ...
      <div dir="ltr" style={{ padding: "0 28px", position: "relative", zIndex: 2 }}>
        ...
        {activeTab === "intel" && (() => {
          ...
          // Always project dynamically using per-country bounds — never use pre-baked paths
      ...
      {activeTab === "flights" && (() => {
        return (
          <div style={{ padding: "40px 20px", textAlign: "center" }}>
            <div style={{ background: CARD_BG, backdropFilter: GLASS_BLUR, border: GLASS_BORDER, borderRadius: GLASS_RADIUS, padding: 40, maxWidth: 500, margin: "0 auto" }}>
              <h3 style={{ fontSize: 18, fontWeight: 700, color: TEXT, marginBottom: 12 }}>Flight Tracker</h3>
              <p style={{ fontSize: 13, color: SUBTEXT, marginBottom: 24 }}>Flight data has moved to the standalone GCC Airport Flight Tracker with all airports in one view.</p>
              <button onClick={() => { window.location.hash = "/flights"; }} style={{
                background: "linear-gradient(135deg, #F59E0B, #D97706)", color: "#050B1A",
                border: "none", borderRadius: GLASS_RADIUS, padding: "12px 32px",
                fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: DM_SANS,
              }}>&rarr; Open Flight Tracker</button>
            </div>
          </div>
        );
      ...
      <div style={{ textAlign: "center", marginTop: 32, fontSize: 11, color: "#E8E8ED55", fontFamily: DM_SANS }}>
        ...
        {" \u00B7 "}
        <a href="#/sources" style={{ color: "#F59E0B", opacity: 0.6, fontSize: 12, textDecoration: "none" }}>
          Data Sources
        </a>
      </div>
      {mapModalCountry && (
