...
const GCC_GEOGRAPHY = {
  ...
  iran: {
    ...
    pts: [
      ...
      [26.0,60.0],[27.0,60.0],[28.5,60.0],[30.0,60.0],[31.5,60.0],[33.0,60.0],[34.5,60.0],[36.0,60.0],[37.5,60.0],
      // Northern border west
      [37.5,58.0],[37.5,56.0],[37.5,54.0],[37.5,52.0],[37.5,50.0],
      // Iraq/Turkey border
      [37.0,49.0],[36.5,48.5],[36.0,48.0],[35.5,47.5],[35.0,46.5],[34.5,46.0],[34.0,45.5],
      // Iraq border south
  ...
  iraq: {
    ...
    pts: [
      ...
      [30.5,48.0],[30.0,48.8],
      // Iran border north
      [31.0,47.5],[31.5,47.0],[32.0,46.0],[32.5,45.5],[33.0,45.5],[33.5,45.5],[34.0,45.5],
      // Turkey border
      [35.0,46.5],[35.5,46.0],[36.0,45.5],[36.5,44.5],[37.0,44.0],[37.4,43.5],[37.4,42.5],
      // Syria border
  ...
  jordan: {
    ...
    pts: [
      [33.0,39.0],[33.5,38.0],[33.0,36.5],[33.0,35.8],[32.5,35.5],[31.5,35.5],[31.0,35.0],[30.0,35.0],[29.5,34.8],[29.5,36.0],[30.0,37.0],[30.5,37.5],[31.0,38.0],[31.5,38.5],[32.0,39.0],[32.5,39.0],[33.0,39.0]
    ],
  },
  syria: {
    name: "SYRIA", color: "#0E1A2A", labelLat: 35.0, labelLng: 38.5,
    pts: [
      // South border (Jordan/Israel/Lebanon)
      [33.0,36.5],[33.5,36.0],[33.5,35.6],[34.7,36.0],[35.0,36.0],[35.5,36.0],[35.8,35.8],
      // Mediterranean coast
      [36.0,35.8],[36.5,36.0],[36.8,36.3],
      // Turkey border
      [37.0,36.5],[37.0,37.5],[37.0,38.5],[37.0,39.5],[37.0,40.5],[37.0,41.5],[37.0,42.0],
      // Iraq border
      [36.5,42.0],[36.0,41.5],[35.5,41.0],[35.0,41.0],[34.5,41.0],[34.0,41.0],[33.5,41.0],
      // Jordan border
      [33.0,39.0],[33.5,38.0],[33.0,36.5]
    ],
  },
  lebanon: {
    name: "", color: "#0E1A2A",
    pts: [
      [34.7,36.0],[34.5,35.8],[34.0,35.8],[33.7,35.6],[33.5,35.6],[33.5,36.0],[34.7,36.0]
    ],
  },
  israel: {
    name: "", color: "#0E1A2A",
    pts: [
      [33.0,35.8],[33.5,35.6],[33.7,35.6],[34.0,35.8],[34.5,35.8],[33.5,35.3],[33.0,35.0],[32.5,34.8],[32.0,34.5],[31.5,34.5],[31.0,34.5],[30.5,34.8],[29.5,34.8],[30.0,35.0],[31.0,35.0],[31.5,35.5],[32.5,35.5],[33.0,35.8]
    ],
  },
  turkey: {
    name: "TURKEY", color: "#0E1A2A", labelLat: 37.3, labelLng: 38.0,
    pts: [
      // Southern border only (rest is off-map)
      [37.0,36.5],[36.8,36.3],[36.5,36.0],[36.0,35.8],[35.8,35.8],[35.5,36.0],[35.0,36.0],[35.0,34.0],
      // Mediterranean coast northwest (off map)
      [37.5,34.0],[37.5,36.0],[37.5,38.0],[37.5,40.0],[37.5,42.0],[37.5,43.5],
      // Iraq border
      [37.4,43.5],[37.4,42.5],[37.0,42.0],[37.0,41.5],[37.0,40.5],[37.0,39.5],[37.0,38.5],[37.0,37.5],[37.0,36.5]
    ],
  },
  egypt: {
    ...
    pts: [
      // Sinai + Red Sea coast
      [31.5,34.5],[31.0,34.5],[30.5,34.0],[30.0,33.0],[29.5,33.0],[29.0,33.0],[28.0,33.5],[27.5,34.0],[27.0,34.0],[24.0,35.5],[22.0,36.5],[22.0,34.0],[25.0,34.0],[29.5,34.0],[29.5,34.8],[30.5,34.8],[31.0,34.5],[31.5,34.5]
    ],
  },
  somalia: {
    name: "SOMALIA", color: "#0E1A2A",
    pts: [
      // North coast (Gulf of Aden)
      [12.0,43.3],[11.5,43.5],[11.0,44.0],[11.2,45.0],[11.0,46.0],[11.5,47.0],[12.0,48.0],[12.0,49.0],[12.0,50.0],[11.5,51.0],
      // Off map south
      [10.0,51.5],[10.0,44.0],[12.0,43.3]
    ],
  },
  djibouti: {
    name: "", color: "#0E1A2A",
    pts: [[12.5,43.5],[12.0,43.3],[11.5,43.0],[11.5,42.5],[11.5,42.0],[12.0,42.0],[12.5,42.5],[12.5,43.5]],
  },
  eritrea: {
    name: "", color: "#0E1A2A",
    pts: [[18.0,38.0],[17.0,38.5],[16.0,39.0],[15.0,39.5],[14.5,40.0],[13.5,41.5],[13.0,42.0],[12.5,42.5],[12.0,42.0],[11.5,42.0],[11.0,41.5],[11.5,40.5],[13.0,40.0],[14.0,39.0],[15.0,38.5],[16.0,38.0],[18.0,38.0]],
  },
};
