...
const GCC_GEOGRAPHY = {
  ...
  saudiArabia: {
    ...
    pts: [
      ...
      [32.0,39.0],[29.5,34.8],[28.0,35.2],[27.0,36.7],[25.5,37.2],[24.5,37.5],[23.5,38.5],[22.0,39.0],[20.5,39.5],[19.0,40.0],[17.5,41.0],[16.5,42.5],
      // Yemen border
      [16.0,43.0],[16.5,43.5],[17.0,44.5],[17.5,46.0],[18.0,48.5],[19.0,48.0],[19.5,49.5],[20.0,50.5],[19.5,51.5],[19.5,52.0],[19.0,55.0],
      // Oman border
      [21.5,55.0],[22.0,55.0],[22.50,55.01],[22.70,55.21],[23.12,55.25],[23.77,55.57],[23.97,55.48],
      // UAE border
      [24.08,56.02],[24.24,55.95],[24.23,55.78],[24.70,55.82],[24.98,55.01],[24.83,54.72],[24.47,54.30],[24.42,54.26],[24.30,54.09],[24.15,54.11],[24.06,53.87],[24.20,52.60],[24.00,52.32],[24.27,51.78],[24.36,51.58],[23.98,51.57],[23.00,52.00],
      ...
      // Kuwait border area
      [28.55,47.70],[28.55,47.43],[28.67,47.45],[29.10,47.00],[29.35,47.00],[29.50,47.40],[30.00,47.00],
      // Iraq border, north to Red Sea
      [30.5,47.7],[30.50,46.50],[31.00,46.0],[31.50,44.0],[31.80,42.0],[32.0,39.0]
    ],
  },
  oman: {
    name: "OMAN", color: "#0E1A2A", labelLat: 23.5, labelLng: 57.0,
    // Musandam peninsula (north) + main Oman body as one polygon via the UAE/Saudi border
    pts: [
      // Musandam peninsula
      ...
      // South along UAE eastern border
      [24.08,56.02],[23.97,55.48],[23.77,55.57],[23.12,55.25],[22.70,55.21],[22.50,55.01],
      // South to Yemen border
      [22.0,55.0],[21.5,55.0],[20.5,55.5],[19.0,55.0],[18.0,53.5],
      // East coast up along Arabian Sea / Gulf of Oman
      [17.0,54.0],[17.5,55.5],[18.0,56.0],[19.5,57.5],[20.0,58.0],[20.5,58.5],[21.0,59.0],[21.5,59.5],[22.0,59.8],[22.5,59.8],[23.0,59.5],[23.5,58.8],[24.0,58.0],[24.2,57.5],[24.5,57.0],[24.6,56.8],
      // Back north along UAE border to Musandam
      [24.40,56.55],[24.08,56.02],[24.24,55.95],[24.23,55.78],[24.70,55.82],[24.95,55.88],[25.00,55.98],[25.15,55.98],[25.25,55.99],[25.30,55.96],[25.37,56.00],[25.39,55.98],[25.43,56.05],[25.50,56.10],[25.55,56.20],[25.65,56.30],[25.80,56.33],[25.85,56.40],[25.95,56.38],[26.07,56.09],[26.08,56.16],[26.10,56.25],[26.35,56.30]
    ],
  },
  iran: {
  ...
  iraq: {
    name: "IRAQ", color: "#0E1A2A", labelLat: 33.0, labelLng: 44.5,
    pts: [
      [30.5,48.0],[31.0,47.5],[31.5,47.0],[32.0,47.5],[33.0,47.5],[33.5,48.0],[34.0,48.0],[34.5,47.5],[35.0,47.0],[35.5,46.0],[36.0,45.5],[36.5,44.5],[37.0,44.0],
      // Northern border (extends to map edge)
      [37.5,43.0],[37.5,42.5],[37.0,42.0],[36.5,41.5],[36.0,41.0],[35.5,40.5],[35.0,40.0],[34.5,39.5],[34.0,39.0],
      // Western border down
      [34.0,39.0],[33.5,40.0],[33.0,41.0],[33.0,42.0],[32.5,42.5],[32.0,43.0],[31.5,43.5],[31.0,44.0],[30.5,44.5],[30.0,45.5],[29.5,46.5],[29.5,47.0],[30.0,47.0],[30.5,47.7],[30.5,48.0]
    ],
  },
  yemen: {
    name: "YEMEN", color: "#0E1A2A", labelLat: 15.5, labelLng: 47.0,
    pts: [
      // Northern border with Saudi (connecting seamlessly)
      ...
      [15.0,43.0],[13.5,43.5],[12.5,43.5],[12.5,44.5],[13.0,45.5],[13.5,47.0],[14.0,48.5],[14.5,49.5],[15.0,50.5],[15.5,51.5],[16.0,52.5],[16.5,53.0],
      // Eastern coast connecting to Oman
      [17.0,53.5],[17.0,54.0],[18.0,53.5],[19.0,55.0]
    ],
  },
};
